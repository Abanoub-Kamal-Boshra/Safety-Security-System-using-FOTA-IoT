...
#include "MQ_4_interface.h"
#include "MQ_4_private.h"
#include "MQ_4_config.h"

u32 HMQ_4_u32ReadAnalogVolt_mv(u8 Copy_u8Channel )
{
...
f32 HMQ_2_f32_ReadData_ppm(u8 Copy_u8Channel)
{
	u8 Copy_u8Sample_Time  = 7;
	u32 Local_u32Analog_mv = 0 ;
